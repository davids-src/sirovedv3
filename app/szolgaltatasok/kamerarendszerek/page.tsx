...
const faqs = [
  ...
  { q: 'Mennyi idő alatt készül el a telepítés?', a: 'Egy tipikus, 4–8 kamerás rendszer telepítése általában 1–2 munkanap alatt elvégezhető. A felmérés és az ajánlat elkészítése általában 24 órán belül megtörténik.' },
  { q: 'Meglévő kamerarendszert is lehet bővíteni vagy javítani?', a: 'Igen! Nem csak új rendszereket telepítünk — meglévő rendszerek hibáit is megjavítjuk, régi kamerákat cserélünk, és bővítéseket elvégzünk. Ha valami nem működik jól, hívj minket.' },
  { q: 'Távolról is figyelhetem a kamerákat?', a: 'Igen. A modern IP kamerarendszerek lehetővé teszik, hogy okostelefonon vagy tableten, bárhonnan valós idejű képet láss az ingatlanodról. Ezt az alkalmazást a telepítés után bemutatjuk és beállítjuk neked.' },
      ...
      <main className="pt-16">
        ...
        <section className="py-28 bg-[#111116]/50 border-b border-[#2A2A35]/50">
          <div className="max-w-site mx-auto px-6">
            <motion.div className="mb-14" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} custom={0} variants={reveal}>
              ...
              <h2 className="font-display mt-6 text-3xl font-semibold text-ink tracking-[-0.02em] leading-[1.15]">Mit nyersz egy kamerarendszerrel?</h2>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { title: 'Biztonságérzet és nyugalom', desc: 'Bármikor, bárhonnan megnézheted, mi történik az otthonodban vagy az üzletedben. Ez egy különleges megnyugvás, amit nehéz más módon megszerezni.' },
                ...
                { title: 'Kontroll és átláthatóság', desc: 'Ha valami történt, visszanézheted a felvételeket. Dolgozók, szállítások, látogatók — mindenről pontos képed van, ami vitás esetekben is segít.' },
              ].map(({ title, desc }, i) => (
                <motion.div key={title}
        ...
        <section className="py-28 bg-bg border-b border-[#2A2A35]/50">
          <div className="max-w-site mx-auto px-6">
            <motion.div className="mb-14" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} custom={0} variants={reveal}>
              ...
              <p className="mt-5 text-muted leading-[1.7]">Egyszerű, átlátható folyamat — te mindig tudod, mi a következő lépés.</p>
            </motion.div>
        ...
        <section className="py-16 bg-[#111116]/50 border-b border-[#2A2A35]/50">
          <div className="max-w-site mx-auto px-6">
            ...
            >
              <h2 className="font-display text-xl font-semibold text-ink mb-4">Kamerarendszer telepítés Székesfehérváron és Fejér megyében</h2>
              ...
              <p className="text-muted text-sm leading-[1.7]">
                ...
                vagy csak egy kamera nem működik, azt is szívesen vállaljuk. Az első konzultáció mindig ingyenes és kötelezettségmentes.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-site mx-auto px-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted text-lg leading-[1.7] mb-3 max-w-xl">Az első konzultáció minden esetben ingyenes és kötelezettségmentes. Keress minket bármilyen kérdéssel!</p>
