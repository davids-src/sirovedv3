...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'biztonsági kamera',
    'IP kamera rendszer',
    '4K biztonsági kamera',
    'kültéri biztonsági kamera',
    'vezeték nélküli kamerarendszer',
    'wifi biztonsági kamera',
    'éjjellátó kamera rendszer',
    'biztonsági kamera telepítés otthonra',
    'CCTV rendszer vállalkozásoknak',
    'kamerarendszer telepítés cégeknek',
    'kamerarendszer telepítés családi házhoz',
    'kamera rendszer raktárhoz',
    'irodai kamerarendszer',
    'ükleti CCTV rendszer',
    'társasházi kamerarendszer',
    'parkoló megfigyelő kamera rendszer',
    'rendszamfelismerő kamera',
    'arcfelismerő biztonsági kamera',
    'távoli elérésű kamerarendszer',
    'felhő alapú kamerarendszer',
    'kamerarendszer mobiltelefonra',
    'kamera rendszer online megfigyeléssel',
    'kamerarendszer telepítő szakember',
    'kamera karbantartás',
    'biztonsági kamera javítás',
    'kamerarendszer szerviz',
    'kamerarendszer éjjellátó funkcióval',
    'kamera rendszer mobilos megfigyelés',
    ...
    'kamerarendszer telepítés családi házhoz Székesfehérváron',
    'wifi kamera telepítés otthonra',
    'éjjellátó kültéri kamera telepítés',
    'irodai kamerarendszer telepítés árral',
    'raktár kamerarendszer telepítés vállalkozásoknak',
    'kamerarendszer ár',
    'biztonságtechnika árajánlat',
    'kamerarendszer telepítés mennyibe kerül',
