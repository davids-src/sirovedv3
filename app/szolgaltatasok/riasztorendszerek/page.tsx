...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'riasztó karbantartás',
    'lakásriasztó rendszer',
    'vezeték nélküli riasztórendszer',
    'okos riasztó telepítés',
    'riasztó rendszer GSM modullal',
    'riasztó távfelfigyelettel',
    'riasztó szerviz',
    'riasztó javítás',
    'riasztó rendszer bővítés',
    'nyitásérzékelő telepítés',
    'ablaknyitás érzékelő',
    'ajtónyitás érzékelő',
    'vezetékes riasztórendszer',
    'házriasztó rendszer',
    'üzleti riasztórendszer',
    'telephely riasztórendszer',
    'riasztórendszer telepítése házba',
    'betörésvédelmi rendszer irodának',
    'riasztó mobilos értesítéssel',
    'PIR szenzor riasztó rendszer',
    'riasztórendszer karbantartás és javítás',
    ...
    'vezeték nélküli riasztórendszer családi házba',
    'riasztó rendszer telepítés távfelfigyelettel',
    'okos riasztó mobilalkalmazással',
    'irodai riasztórendszer telepítés',
    'betörésvédelem üzlethelyiség számára',
    'riasztó telepítés ár',
    'biztonságtechnika árajánlat',
    'riasztórendszer ár telepítéssel együtt',
